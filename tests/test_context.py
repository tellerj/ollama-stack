...
@patch('ollama_stack_cli.context.StackManager')
@patch('ollama_stack_cli.context.Display')
@patch('ollama_stack_cli.context.Config', side_effect=Exception("Config Error"))
...
@patch('ollama_stack_cli.context.StackManager')
@patch('ollama_stack_cli.context.Config')
def test_app_context_display_initialization_failure(MockConfig, MockStackManager):
    """
