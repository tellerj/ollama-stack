...
class TestCommandRegistration:
    ...
    def test_all_commands_are_registered(self):
        ...
        expected_commands = ["start", "stop", "restart", "status", "logs", "check", "install", "update", "uninstall"]
...
class TestBasicCommandRouting:
    ...
    def test_commands_can_be_invoked(self, MockAppContext):
        ...
        # For install command
        mock_context.stack_manager.install_stack.return_value = True
        ...
        commands = ["start", "stop", "restart", "status", "logs", "check", "install", "update", "uninstall"]
